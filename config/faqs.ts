export const FAQS_EN = [
  {
    title: "Why use PopupWord?",
    content:
      "Unlike conventional vocabulary apps that require active usage for memorization, PopupWord seamlessly integrates into your daily mobile and browser activities, helping you learn words through repetition – again and again – building muscle memory for words.",
  },
  {
    title: "How do I use PopupWord?",
    content:
      "PopupWord is available for both Android devices and as a browser extension. On Android, installation necessitates enabling accessibility services and permission for floating windows; once activated, it operates automatically. The browser plugin version becomes operational immediately after installation, with minimal configuration required.",
  }
];
...
export const FAQS_ZH = [
  {
    title: "为什么要使用弹词？",
    content:
      "不需要像市面上记忆单词软件一样，被动的打开去记忆单词，弹词能够在你日常的使用手机、浏览器上帮助你更好的学习单词，反复、反复、再反复。建立单词的肌肉记忆。",
  },
  {
    title: "怎么使用弹词?",
    content:
      "弹词分为Android端和浏览器插件端,Android端安装需要获取无障碍辅助功能和悬浮窗权限,开启后便自动启用。浏览器插件版则安装后立即启用，无需过多设置。",
  }
];
