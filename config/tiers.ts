...
export const TIERS_EN: Array<Tier> = [
  {
    key: TiersEnum.Free,
    title: "Open-Source Android Version / Free",
    price: "Free",
    href: siteConfig.openSourceURL || "#",
    description: "Clone the open-source Android version from our GitHub repository for free and use it as a base for further development.",
    features: [
      "Free of charge",
      "Full code access",
...
export const TIERS_ZH: Array<Tier> = [
  {
    ...
    price: "免费",
    href: siteConfig.openSourceURL || "#",
    description: "可从GitHub仓库免费克隆Android版开源版，并使用开源版进行二次开发。",
    features: [
      "免费",
      "访问全部代码",
      "二次开发",
